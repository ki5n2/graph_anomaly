...
experiments=(
"--dataset-name Tox21_HSE --random-seed 1 --epochs 100 --n-cluster 1 --learning-rate 0.0001 --beta 10.0"
"--dataset-name Tox21_p53 --random-seed 1 --epochs 100 --n-cluster 1 --learning-rate 0.0001 --beta 0.0"
"--dataset-name Tox21_MMP --random-seed 1 --epochs 100 --n-cluster 1 --learning-rate 0.0001 --beta 0.0"
"--dataset-name Tox21_HSE --random-seed 1 --epochs 100 --n-cluster 1 --learning-rate 0.0001 --beta 0.0"
)
...
EXECUTION_FILE=/home1/rldnjs16/graph_anomaly_detection/BERT_model18_Tox21.py
