    ...
    for data in train_loader:
        ...
        for i in range(num_graphs):
            ...
            if epoch % 5 == 0:
                ...
                graph_vec = graph_representations[i].detach().cpu().numpy()
        ...
        if is_pretrain:
            ...
            for i in range(num_graphs):
                ...
                if self.pooling_type == 'mean':
                    ...
                    pooled = torch.max(graph_nodes, dim=0)[0]
                else:
            ...
            return graph_representations, x_recon, stats_pred, adj_recon_list
