    ...
    for data in train_loader:
        ...
        for i in range(num_graphs):
            ...
            if dataset_name == 'AIDS':
                ...
                # stats_loss_ = torch.norm(true_stats[start_node:end_node] - stats_pred[start_node:end_node], p='fro')**2
                stats_loss_ = F.mse_loss(stats_pred[start_node:end_node], true_stats[start_node:end_node], reduction='sum')
            else:
        ...
        for data in test_loader:
            ...
            for i in range(num_graphs):
                ...
                if dataset_name == 'AIDS':
                    ...
                    # stats_loss = torch.norm(true_stats[start_idx:end_idx] - stats_pred[start_idx:end_idx], p='fro')**2
                    stats_loss = F.mse_loss(stats_pred[start_idx:end_idx], true_stats[start_idx:end_idx], reduction='sum')
                else:
