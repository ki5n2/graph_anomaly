...
from modules.utils import set_seed, set_device, EarlyStopping, read_graph_file, get_ad_dataset_Tox21, adj_original, batch_nodes_subgraphs
...
class GRAPH_AUTOENCODER(nn.Module):
    ...
    def forward(self, x, edge_index, batch, num_graphs):
        ...
        encoded = self.transformer(z_with_cls_batch, src_key_padding_mask=mask)
