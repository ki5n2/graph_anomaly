...
experiments=(
"--dataset-name AIDS --batch-size 300 --random-seed 1 --epochs 100 --n-cluster 1 --learning-rate 0.0001"
)
...
EXECUTION_FILE=/home1/rldnjs16/graph_anomaly_detection/BERT_model17.py
