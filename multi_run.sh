...
"--dataset-name BZR --random-seed 1 --epochs 150 --n-cluster 1 --learning-rate 0.0001"
"--dataset-name DHFR --random-seed 1 --epochs 150 --n-cluster 1 --learning-rate 0.00001"
...
EXECUTION_FILE=/home1/rldnjs16/graph_anomaly_detection/AB_CLS.py
