...
def train(model, train_loader, optimizer, max_nodes, device):
    ...
    for data in train_loader:
        ...
        node_loss = torch.norm(x_recon - x, p='fro')**2 / num_nodes
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, src, edge_index_list, src_key_padding_mask):
        ...
        output_T = self.transformer(src_T, src_key_padding_mask=src_key_padding_mask)
        output = output_T.transpose(0, 1)  # [batch_size, seq_len, hidden_dim]
