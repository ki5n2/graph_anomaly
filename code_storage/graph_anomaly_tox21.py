...
graph_dataset = TUDataset(root=data_root, name=data_name).shuffle()
...
model = GRAPH_AUTOENCODER_(num_features, hidden_dims, max_nodes, dropout_rate=0.2).to(device)
