...
def run(dataset_name, random_seed, device=device, epoch_results=None):
    ...
    # BERT 모델 저장 경로
    bert_save_path = f'/home1/rldnjs16/graph_anomaly_detection/BERT_model/Tox21/all_pretrained_bert_{dataset_name}_nhead{n_head_BERT}_seed{random_seed}_BERT_epochs{BERT_epochs}_try20.pth'
